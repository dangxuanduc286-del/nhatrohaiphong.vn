...
function getPostRoomCta(role: Awaited<ReturnType<typeof getViewerRole>>) {
  if (role === "LANDLORD")
          ...
          <div className="flex items-center gap-2">
            ...
            <details className="relative lg:hidden">
              ...
              <div className="absolute right-0 top-12 w-72 rounded-3xl border border-slate-200 bg-white p-3 shadow-xl">
                {["Tìm phòng", "Khu vực", "Gần KCN", "Gần trường", "Gần bệnh viện"].map((item) => (
                  <Link
                    key={item}
                    href={
                      item === "Tìm phòng"
        ...
        <div className="overflow-hidden rounded-3xl bg-[#111827] p-6 text-white shadow-xl sm:p-8 lg:flex lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-200">
              Tập trung vào hai hành động chính: người thuê xem phòng đang trống, chủ trọ đăng tin
